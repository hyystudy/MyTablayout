...
public class MyTabLayout  extends HorizontalScrollView{
    ...
    /**
     * Gravity used to fill the {@link } as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link }.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    private void animateToTab(int newPosition) {
        ...
        if (startScrollX != targetScrollX) {
            if (mScrollAnimator == null) {
                mScrollAnimator = ValueAnimator.ofInt(startScrollX, targetScrollX);
    ...
    class TabView extends LinearLayout implements View.OnLongClickListener {
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (maxWidth > 0 && (specWidthMode == MeasureSpec.UNSPECIFIED
                ...
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(mTabMaxWidth>>2, MeasureSpec.AT_MOST);
            } else {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        private void setIndicatorPosition(int left, int right) {
            if (left != mIndicatorLeft || right != mIndicatorRight) {
                ...
                int indicatorMargin = (int) (width - INDICATOR_WIDTH *getResources().getDisplayMetrics().density)/2;
                mIndicatorLeft = left + indicatorMargin;
                mIndicatorRight = right - indicatorMargin;
                ViewCompat.postInvalidateOnAnimation(this);
            }
        }
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ValueAnimator animator = mIndicatorAnimator = ValueAnimator.ofFloat(0, 1);
